...
import no.dusken.momus.common.exceptions.ExceptionHandler;
import no.dusken.momus.person.PersonRepository;
import no.dusken.momus.person.authentication.UserDetailsService;
import no.dusken.momus.person.authentication.UserDetailsServiceDev;
import no.dusken.momus.person.authentication.UserDetailsServiceImpl;
...
@EnableJpaRepositories(basePackages = "no.dusken.momus")
...
class ApplicationConfig extends WebMvcConfigurationSupport {
    ...
    @Profile("noAuth")
    public UserDetailsService userDetailsServiceDev(AuthenticationManager authenticationManager) {
        return new UserDetailsServiceDev(authenticationManager);
    }
