...
public class ArticleServiceTest extends AbstractTestRunner {
    ...
    public void testEmptyArticleSearchReturnsAll() {
        ArticleSearchParams params = new ArticleSearchParams("", "", Collections.<String>emptySet(), "", "");
    ...
    public void testSearchingForContent() {
        ArticleSearchParams params = new ArticleSearchParams("søke i dette", "", Collections.<String>emptySet(), "", "");
